...
function getStylesConfig(wco) {
    ...
    const postcssPluginCreator = function () {
        ...
        if (appConfig.postCssPlugins && appConfig.postCssPlugins.length > 0) {
            postCssExtraPlugins = appConfig.postCssPlugins.map((pluginName) => require(pluginName)());
        }
        return [
            postcssUrl({
                url: (URL) => {
...
//# sourceMappingURL=/users/mikkeldamm/forked-repos/angular-cli/models/webpack-configs/styles.js.map